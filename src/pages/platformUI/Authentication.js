                ...
                <div className="addCard">
                    ...
                    <div className="addCardText">
                        ...
                        <p className="addCardPara">
                            Authentication lets users prove their identity to your app and authorize Zapier to access their data, using your API authentication scheme. <a href="">Learn more</a>.
                        </p>
                    </div>
                </div>
                <form>
